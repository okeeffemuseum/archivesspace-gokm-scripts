...
# Column 2 contains the Subject Record ID
...
# object's JSON, and append to existing AO subject information supplied in the input CSV,
...
archival_object_csv = "depicted_subjects_update.csv"
...
updated_archival_object_csv = "depicted_subjects_updated.csv"

# Modify your ArchivesSpace backend url, username, and password as necessary
aspace_url = 'http://archivesspace:8089' #Backend URL for ASpace
username= 'admin'
password = 'admin'
...
with open(archival_object_csv,'rt', encoding ="utf8") as csvfile:
    ...
    for row in reader:
        ...
        if archival_object_json['ref_id'] == ref_id:
            ...
            subj_instance = {'role': 'subject', 'relator': 'dpc', 'terms': [], 'ref': '/agents/people/'+subj_rec_id}
