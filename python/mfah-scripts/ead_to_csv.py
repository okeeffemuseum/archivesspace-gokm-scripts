...
xmlfile = input("Enter path to EAD file: ")
output_filename = input("Enter filename of output CSV with file extension: ")
...
def save(refid_component_array, csv_file_name): 
    ...
    #fields = ['refid', 'componentid', 'title'] 
    fields = ['refid', 'title'] 
...
for filechild in filechildren:
    ...
    #refid_components.append({"refid":ref_id, "componentid":component_id, "title":title})
...
save(refid_components, output_filename)
