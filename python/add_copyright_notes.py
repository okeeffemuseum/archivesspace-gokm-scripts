...
def delete_note():
    ...
    for row in csvfile:
        ...
        copyright_notes = [{"jsonmodel_type":"note_multipart","label":"Copyright Management","type":"userestrict","rights_restriction":{"local_access_restriction_type":[]},"subnotes":[{"jsonmodel_type":"note_text","content":"www.okeeffemuseum.org/image-rights-and-reproductions/","publish":True}],"publish":True}, {"jsonmodel_type":"note_multipart","label":"Explanation of Rights","type":"legalstatus","subnotes":[{"jsonmodel_type":"note_text","content":"https://rightsstatements.org/page/1.0/?language=en","publish":True}],"publish":True}]
