...
#this version includes all resources published to Collections Online
...
# List of EADID values (e.g. johndoepapers, janedoepapers, johnandjanedoepapers)
#eadids = input("List of EADIDs:  ")
eadids = "gokm0003, gokm0006, MS-006_ead, gokm0009, gokm0010, gokm0011, gokm0012, gokm0017, gokm0029, gokm0031, MS-038_ead"
