...
#from duke archivesspace-duke-scripts/python/as-batch-delete-digital-objects-by-identifier.py
#tested and modified by L.Neely at GOKM 3/2/2022
...
#expects header, one column?

digital_objects_to_delete = input("Path to input CSV: ")

#prompt for output path
deleted_digital_objects = input("Path to output CSV: ")


with open(digital_objects_to_delete,'r') as csvfile, open(deleted_digital_objects,'w') as csvout:
...
#    print 'Processing delete batch...'
    ...
    for row in csvin:
        ...
        with open(deleted_digital_objects,'a') as csvout:
